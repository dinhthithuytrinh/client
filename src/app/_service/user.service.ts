...
export class UserService {
  ...
  public createUserFormDate(loggedInUsername: string, user: User, avatar: File): FormData {
    ...
    formData.append('status', JSON.stringify(user.status));
    formData.append('isNotLoked', JSON.stringify(user.isNotLoked));
